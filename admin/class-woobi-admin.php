...
<!--            }-->
<!---->
<!--            .table-nested tr:first-child th, .table-nested tr:first-child td {-->
<!--                border-top: none;-->
<!--            }-->
<!---->
<!--            .table-nested tr th:first-child, .table-nested tr td:first-child {-->
<!--                border-left: none;-->
<!--            }-->
<!---->
<!--            .table-nested tr th:last-child, .table-nested tr td:last-child {-->
<!--                border-right: none;-->
<!--            }-->
<!---->
<!--            .p-0 {-->
...
<!--            }-->
<!---->
<!--            .woo-bi-pivot .woo-bi-top-axis-header,-->
<!--            .woo-bi-pivot .woo-bi-left-axis-header {-->
<!--                padding: 0;-->
<!--                margin: 0;-->
<!--            }-->
<!---->
<!--            .woo-bi-pivot .woo-bi-top-axis-header > .woo-bi-header-container {-->
<!--                overflow: hidden;-->
<!--            }-->
<!---->
<!--        </style>-->
